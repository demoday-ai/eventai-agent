...
class TestFormatRecommendations:
    ...
    def test_format_recommendations_normal(self):
        ...
        assert "#1 (score: 90%)" in text
        assert "#2 (score: 85%)" in text
...
class TestGetPipeline:
    ...
    async def test_get_summary_business(self):
        """Business role -> pipeline text with status counts."""
        ...
        project = _make_project(title="DataPipe")
